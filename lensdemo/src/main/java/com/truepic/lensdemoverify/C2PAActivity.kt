...
class C2PAActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    override fun onStart() {
        ...
        viewModel.load(intent.getStringExtra(FilePathExtra), onLoadComplete = {
            ...
            fun bind(item: C2PAViewModel.Item, position: Int) {
                ...
                lifecycleScope.launch(Dispatchers.Default) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        if (item.capturedDateText.isNotEmpty()) {
                            binding.capturedText.text = item.capturedDateText
                            binding.capturedLabel.visibility = View.VISIBLE
                            binding.capturedText.visibility = View.VISIBLE
                        } else {
                            binding.capturedLabel.visibility = View.GONE
                            binding.capturedText.visibility = View.GONE
                        }
